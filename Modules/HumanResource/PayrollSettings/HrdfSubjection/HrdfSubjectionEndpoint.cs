...
[Route("Services/PayrollSettings/HrdfSubjection/[action]")]
[ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
public class HrdfSubjectionEndpoint : ServiceEndpoint
{
    [HttpPost, AuthorizeCreate(typeof(MyRow))]
    public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
        [FromServices] IHrdfSubjectionSaveHandler handler)
    {
        ...
        [FromServices] IHrdfSubjectionSaveHandler handler)
    {
        ...
        try
        {
            ...
            SqlParameter param29 = new SqlParameter("@SubjectionTo", 3);
    ...
    public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
        [FromServices] IHrdfSubjectionDeleteHandler handler)
    {
    ...
    public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
        [FromServices] IHrdfSubjectionRetrieveHandler handler)
    {
    ...
    public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
        [FromServices] IHrdfSubjectionListHandler handler)
    {
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.HrdfSubjectionColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "HrdfSubjectionList_" +
