...
[Route("Services/PayrollSettings/SocsoSubjection/[action]")]
[ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
public class SocsoSubjectionEndpoint : ServiceEndpoint
{
    [HttpPost, AuthorizeCreate(typeof(MyRow))]
    public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
        [FromServices] ISocsoSubjectionSaveHandler handler)
    {
        ...
        [FromServices] ISocsoSubjectionSaveHandler handler)
    {
        ...
        try
        {
            ...
            SqlParameter param29 = new SqlParameter("@SubjectionTo", 4);
    ...
    public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
        [FromServices] ISocsoSubjectionDeleteHandler handler)
    {
    ...
    public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
        [FromServices] ISocsoSubjectionRetrieveHandler handler)
    {
    ...
    public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
        [FromServices] ISocsoSubjectionListHandler handler)
    {
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.SocsoSubjectionColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "SocsoSubjectionList_" +
