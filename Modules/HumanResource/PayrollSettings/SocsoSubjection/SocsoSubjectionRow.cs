...
[ConnectionKey("Default"), Module("PayrollSettings"), TableName("HumanResourcesPaymentSubjectionToSOCSO")]
[DisplayName("Socso Subjection"), InstanceName("Socso Subjection")]
[ReadPermission("*")]
[ModifyPermission("Administration:HumanResources")]
public sealed class SocsoSubjectionRow : LoggingRow<SocsoSubjectionRow.RowFields>, IIdRow
{
