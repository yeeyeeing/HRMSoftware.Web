...
[Route("Services/PayrollSettings/EpfSubjection/[action]")]
[ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
public class EpfSubjectionEndpoint : ServiceEndpoint
{
    [HttpPost, AuthorizeCreate(typeof(MyRow))]
    public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
        [FromServices] IEpfSubjectionSaveHandler handler)
    {
        ...
        [FromServices] IEpfSubjectionSaveHandler handler)
    {
        ...
        try
        {
            ...
            SqlParameter param29 = new SqlParameter("@SubjectionTo", 1);
    ...
    public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
        [FromServices] IEpfSubjectionDeleteHandler handler)
    {
    ...
    public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
        [FromServices] IEpfSubjectionRetrieveHandler handler)
    {
    ...
    public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
        [FromServices] IEpfSubjectionListHandler handler)
    {
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.EpfSubjectionColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "EpfSubjectionList_" +
