...
[ConnectionKey("Default"), Module("PayrollSettings"), TableName("HumanResourcesPaymentSubjectionToEPF")]
[DisplayName("Epf Subjection"), InstanceName("Epf Subjection")]
[ReadPermission("*")]
[ModifyPermission("Administration:HumanResources")]
public sealed class EpfSubjectionRow : LoggingRow<EpfSubjectionRow.RowFields>, IIdRow// no need logging row
{
