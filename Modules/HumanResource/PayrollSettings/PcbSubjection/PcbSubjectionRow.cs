...
[ConnectionKey("Default"), Module("PayrollSettings"), TableName("HumanResourcesPaymentSubjectionToPCB")]
[DisplayName("Pcb Subjection"), InstanceName("Pcb Subjection")]
[ReadPermission("*")]
[ModifyPermission("Administration:HumanResources")]
public sealed class PcbSubjectionRow : LoggingRow<PcbSubjectionRow.RowFields>, IIdRow
{
