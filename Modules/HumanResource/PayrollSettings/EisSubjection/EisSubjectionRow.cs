...
[ConnectionKey("Default"), Module("PayrollSettings"), TableName("HumanResourcesPaymentSubjectionToEIS")]
[DisplayName("Eis Subjection"), InstanceName("Eis Subjection")]
[ReadPermission("*")]
[ModifyPermission("Administration:HumanResources")]
public sealed class EisSubjectionRow : LoggingRow<EisSubjectionRow.RowFields>, IIdRow
{
