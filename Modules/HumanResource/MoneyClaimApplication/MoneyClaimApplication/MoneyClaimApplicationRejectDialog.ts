...
import { LeaveApplicationForm, LeaveApplicationRejectForm, LeaveApplicationRow, LeaveApplicationService, LeaveStatus, LeaveTypes, MoneyClaimApplicationRejectForm } from '../../../ServerTypes/LeaveApplication';
...
@Decorators.registerClass('HRMSoftware.MoneyClaimApplication.MoneyClaimApplicationRejectDialog')
export class MoneyClaimApplicationRejectDialog extends EntityDialog<MoneyClaimApplicationRejectRow, any> {
    protected getFormKey() { return MoneyClaimApplicationRejectForm.formKey; }
    protected getRowDefinition() { return MoneyClaimApplicationRejectRow; }
    protected getService() { return MoneyClaimApplicationService.baseUrl; }
    protected form = new MoneyClaimApplicationRejectForm(this.idPrefix);
    constructor() {
        super();
