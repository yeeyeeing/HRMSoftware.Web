...
[ConnectionKey("Default"), Module("EmployeeLate"), TableName("HumanResourcesLate")]
[DisplayName("Employee Late"), InstanceName("Employee Late")]
[ReadPermission(PermissionKeys.HumanResources)]
[ModifyPermission(PermissionKeys.HumanResources)]
[LookupScript("EmployeeLate.EmployeeLate", Permission = "*")]
public sealed class EmployeeLateRow : Row<EmployeeLateRow.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Deducted"), Column("Deducted"),StatusFormatter]
    public int? Deducted
    {
    ...
    [DisplayName("Late Mins")]
    public int? LateMins
    {
        get => fields.LateMins[this];
        set => fields.LateMins[this] = value;
    }
    ...
    [DisplayName("Employee Name"), Expression($"c.EmployeeName"), QuickSearch, NameProperty]
