...
@Decorators.registerClass('HRMSoftware.EmployeeProfile.EmployeeIncentiveDialog')
export class EmployeeIncentiveDialog extends EntityDialog<EmployeeIncentiveRow, any> {
    protected getFormKey() { return EmployeeIncentiveForm.formKey; }
    protected getRowDefinition() { return EmployeeIncentiveRow; }
    protected getService() { return EmployeeIncentiveService.baseUrl; }

    protected form = new EmployeeIncentiveForm(this.idPrefix);
