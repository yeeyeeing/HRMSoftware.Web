...
[ConnectionKey("Default"), Module("EmployeeProfile"), TableName("HumanResourcesEmployeeIncentive")]
[DisplayName("Employee Incentive"), InstanceName("Employee Incentive")]
[ReadPermission(PermissionKeys.HumanResources)]
[ModifyPermission(PermissionKeys.HumanResources)]
public sealed class EmployeeIncentiveRow : LoggingRow<EmployeeIncentiveRow.RowFields>, IIdRow, INameRow
{
    ...
    [LookupEditor(typeof(EmployeeProfileRow)), NotNull]    public int? EmployeeRowId
    {
    ...
    [DisplayName("Incentive Amount"),NotNull]
    public double? IncentiveAmount
    {
        get => fields.IncentiveAmount[this];
        set => fields.IncentiveAmount[this] = value;
    }

    [DisplayName("Incentive Description"), QuickSearch]
    public string IncentiveDescription
    {
        get => fields.IncentiveDescription[this];
        set => fields.IncentiveDescription[this] = value;
    }
    ...
    public class RowFields : LoggingRowFields
    {
        ...
        public DoubleField IncentiveAmount;
        public StringField IncentiveDescription;
