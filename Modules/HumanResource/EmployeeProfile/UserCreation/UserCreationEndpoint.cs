...
[Route("Services/EmployeeProfile/UserCreation/[action]")]
...
public class UserCreationEndpoint : ServiceEndpoint
{
    ...
    public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
        [FromServices] IUserCreationDeleteHandler handler)
    {
    ...
    public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
        [FromServices] IUserCreationRetrieveHandler handler)
    {
    ...
    public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
        [FromServices] IUserCreationListHandler handler)
    {
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.UserCreationColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "UserCreationList_" +
