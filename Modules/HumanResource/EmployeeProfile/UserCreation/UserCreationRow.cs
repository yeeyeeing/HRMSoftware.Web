...
[DisplayName("User Creation"), InstanceName("User Creation")]
[ReadPermission("Administration:HumanResources")]
[ModifyPermission("Administration:HumanResources")]
public sealed class UserCreationRow : Row<UserCreationRow.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Employee To Grant HR Priviledge"), NotMapped, 
        LookupEditor(typeof(EmployeeProfileRow), Multiple = true, FilterField = "IsActive", FilterValue = 1)]
    public List<int> EmployeeRowHrPriveledge
    {
        get => fields.EmployeeRowHrPriveledge[this];
        set => fields.EmployeeRowHrPriveledge[this] = value;
    }
    ...
    [DisplayName("Section List"), NotMapped,
      LookupEditor(typeof(OrganisationHierarchy.SectionRow), Multiple = true, FilterField = "IsActive", FilterValue = 1)]
    ...
    [DisplayName("All Employee With No Account"), NotMapped]
    [BooleanEditor]
    public bool? AllEmployee
    {
        get => fields.AllEmployee[this];
        set => fields.AllEmployee[this] = value;
    }
    public class RowFields : RowFieldsBase
    {

        public ListField<int> EmployeeRowHrPriveledge;
        ...
        public BooleanField AllEmployee;
