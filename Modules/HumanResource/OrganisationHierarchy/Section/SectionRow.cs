...
[ConnectionKey("Default"), Module("OrganisationHierarchy"), TableName("HumanResourcesSection")]
...
[LookupScript("Section.Section", Permission = "*")]
public sealed class SectionRow : LoggingRow<SectionRow.RowFields>, IIdRow, INameRow
{
