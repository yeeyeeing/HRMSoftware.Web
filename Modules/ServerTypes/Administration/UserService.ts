...
export namespace UserService {
    ...
    export declare function UserBasedOnId(request: string, onSuccess?: (response: ListResponse<UserRow>) => void, opt?: ServiceOptions<any>): JQueryXHR;
    ...
    export const Methods = {
        ...
        UserBasedOnId: "Administration/User/UserBasedOnId"
    } as const;
